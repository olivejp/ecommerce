...
public class AttributResource {
    ...
    public AttributResource(AttributRepository attributRepository, AttributSearchRepository attributSearchRepository) {
    ...
    public ResponseEntity<Attribut> createAttribut(@RequestBody Attribut attribut) throws URISyntaxException {
    ...
    public ResponseEntity<Attribut> updateAttribut(@RequestBody Attribut attribut) throws URISyntaxException {
