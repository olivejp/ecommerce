...
import nc.oliweb.EcommerceApp;
import nc.oliweb.config.Constants;
import nc.oliweb.domain.PersistentToken;
import nc.oliweb.domain.User;
import nc.oliweb.repository.AuthorityRepository;
import nc.oliweb.repository.PersistentTokenRepository;
import nc.oliweb.repository.UserRepository;
import nc.oliweb.security.AuthoritiesConstants;
import nc.oliweb.service.UserService;
import nc.oliweb.service.dto.PasswordChangeDTO;
import nc.oliweb.service.dto.UserDTO;
import nc.oliweb.web.rest.vm.KeyAndPasswordVM;
import nc.oliweb.web.rest.vm.ManagedUserVM;
...
import static nc.oliweb.web.rest.AccountResourceIT.TEST_USER_LOGIN;
